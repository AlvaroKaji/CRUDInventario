...
public class frmArticulo extends javax.swing.JFrame {
    ...
    private void lstArticuloValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstArticuloValueChanged
        ...
        if(!evt.getValueIsAdjusting()) {
            ...
            String codigo1 = datos[0].replace("Codigo:", "");
            String descripcion1 = datos[1].replace("Descripcion:", "");
            String precio1 = datos[2].replace("Precio:", "");
            txtcodigo1.setText(codigo1);
            txtdescripcion1.setText(descripcion1);
            txtprecio1.setText(precio1);
            lblCodigo.setText(codigo1);
            lblDescripcion.setText(descripcion1);
            lblPrecio.setText(precio1);
            updateArticulo = new clsArticulo(codigo, descripcion, Double.parceDouble(precio));
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int respuesta = JOptionPane.showConfirmDialog(this, 
                "Eliminacion de articulos", "¿Estas seguro de que deseas eliminar el regristo?" +
                        updateArticulo.aTexto()+ "?",
